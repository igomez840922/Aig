...
namespace DataModel
{
    public class FMV_FfTB:SystemId
    {
        public FMV_FfTB()
        {
            LNotificaciones = new List<FMV_FfNotificacionTB>();
        }
        ...
        private List<FMV_FfNotificacionTB> lNotificaciones;
        public virtual List<FMV_FfNotificacionTB> LNotificaciones { get => lNotificaciones; set => SetProperty(ref lNotificaciones, value); }

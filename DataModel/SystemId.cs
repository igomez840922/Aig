...
namespace DataModel
{
    public class SystemId : ValidatableBindableBase, Identity
    {
        ...
        public bool Deleted { get => deleted; set => SetProperty(ref deleted, value); }

        private bool disabled;
        public bool Disabled { get => disabled; set => SetProperty(ref disabled, value); }

        private bool fromSystem;
        public bool FromSystem { get => fromSystem; set => SetProperty(ref fromSystem, value); }

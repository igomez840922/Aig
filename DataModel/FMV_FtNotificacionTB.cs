...
namespace DataModel
{
    public class FMV_FtNotificacionTB: SystemId
    {
        public FMV_FtNotificacionTB()
        {
            FallaReportada  = new FMV_FtNotificacionFallaReportada();
        ...
        */
        ...
        //FALLA REPORTADA
        private FMV_FtNotificacionFallaReportada fallaReportada;
        [System.ComponentModel.DataAnnotations.Schema.NotMapped]
        public FMV_FtNotificacionFallaReportada FallaReportada { get => fallaReportada; set => SetProperty(ref fallaReportada, value); }

            ...
            modelBuilder.Entity("DataModel.FMV_Ram2TB", b =>
                {
                    ...
                    b.Property<long?>("TipoInstitucionTBId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProvinciaTBId");

                    b.HasIndex("TipoInstitucionId")
                        .IsUnique()
                        .HasFilter("[TipoInstitucionId] IS NOT NULL");

                    b.HasIndex("TipoInstitucionTBId");
            ...
            modelBuilder.Entity("DataModel.FMV_Ram2TB", b =>
                {
                    ...
                    b.HasOne("DataModel.ProvinciaTB", null)
                        .WithMany("LRam2")
                        .HasForeignKey("ProvinciaTBId");

                    b.HasOne("DataModel.TipoInstitucionTB", "TipoInstitucion")
                        .WithOne()
                        .HasForeignKey("DataModel.FMV_Ram2TB", "TipoInstitucionId");

                    b.HasOne("DataModel.TipoInstitucionTB", null)
                        .WithMany("LRam2")
                        .HasForeignKey("TipoInstitucionTBId");

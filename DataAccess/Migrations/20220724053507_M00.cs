        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TripleA = table.Column<bool>(type: "bit", nullable: false),
                    CoinBase = table.Column<bool>(type: "bit", nullable: false),
                    BitPay = table.Column<bool>(type: "bit", nullable: false),
                    CoinGate = table.Column<bool>(type: "bit", nullable: false),
                    NowPayments = table.Column<bool>(type: "bit", nullable: false),
                    AlfaCoins = table.Column<bool>(type: "bit", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    Disabled = table.Column<bool>(type: "bit", nullable: false),
                    FromSystem = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrencyCrypto", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrencyFiat", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GateWayNowPayment", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountApiId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GateWayTriplea", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultFiatCurrency = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    DefaultCryptoCurrency = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LogoBase64 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    Disabled = table.Column<bool>(type: "bit", nullable: false),
                    FromSystem = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PosSystem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PosSystem_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosSystemId = table.Column<long>(type: "bigint", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CurrencyFiat = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CurrencyCrypto = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    OrderReference = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    OrderUrl = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_PosSystem_PosSystemId",
                        column: x => x.PosSystemId,
                        principalTable: "PosSystem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

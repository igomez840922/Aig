...
{
    public partial class AddEditMedicamentCommand : IRequest<Result<int>>
    {
    ...
    internal class AddEditMedicamentCommandHandler : IRequestHandler<AddEditMedicamentCommand, Result<int>>
    {
        ...
        public AddEditMedicamentCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, IUploadService uploadService, ISystemLogger systemLogger)
        {
        ...
        public async Task<Result<int>> Handle(AddEditMedicamentCommand request, CancellationToken cancellationToken)
        {

...
namespace Aig.Farmacoterapia.Application.Features.Account.Queries
{
    ...
    internal class GetAvatarHandler : IRequestHandler<GetAvatarQuery, FileStreamResult>
    {
        private readonly IUploadService _uploadService;
        private readonly ISystemLogger _logger;

        public GetAvatarHandler(IUploadService uploadService, ISystemLogger logger)
        {

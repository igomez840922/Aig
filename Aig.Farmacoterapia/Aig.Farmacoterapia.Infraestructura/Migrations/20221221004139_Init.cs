        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotaEvaluacion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AspectosSobresalientes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RegistroProtocolo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FormDataURL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AigEstudios", x => x.Id);
                });

    ...
    public class NoteReport : IDocument
    {
        ...
        void LogoBody(IContainer container)
        {
            container.ShowEntire().Row(row =>
            {
                ...
                row.RelativeItem().AlignCenter().Width(220).Height(64).Image(data);
            });
        }
        ...
        void HeaderBody(IContainer container)
        {
            container.Grid(grid => {
                ...
                grid.Item(12).Row(row =>
                {
                    row.RelativeItem().PaddingTop(10).PaddingBottom(3).PaddingLeft(100).PaddingRight(100).BorderBottom(0.5f).BorderColor("#A2A2A2");
                });
                ...
                column.Item().Row(row =>
                {
                    row.RelativeItem().Column(column =>
                    {
                        ...
                        column.Item().Text(text =>
                       {
                         ...
                         text.Span(Model.Nota?.GetNoteCode(Model.Id)).SemiBold().FontColor("#3b3c3c");
                     });
                        column.Item().Text(text =>
                       {
                         //text.Span("Fecha de evaluación: ").SemiBold();
                         text.Span($"{Model.Nota?.FechaEvaluacion:d}").SemiBold().FontColor("#3b3c3c");
                       });
                  });
                        ...
                        row.RelativeItem().Column(column =>
                        {
                            ...
                            if (!string.IsNullOrEmpty(Model.Tramitante.Nombre))
                            {
                                column.Item().Text(text =>
                                {
                                    ...
                                    text.Span(Model.Tramitante.Nombre).SemiBold().FontColor("#3b3c3c");
                                });
                            }
                            ...
                            if (!string.IsNullOrEmpty(Model.Tramitante.Idoneidad))
                            {
                                column.Item().Text(text =>
                                {
                                    ...
                                    text.Span(Model.Tramitante.Idoneidad).SemiBold().FontColor("#3b3c3c");
                                });
                            }
                            if (!string.IsNullOrEmpty(Model.AgenciaDistribuidora))
                            {
                                column.Item().Text(text =>
                                {
                                   //text.Span("Agencia distribuidora: ").SemiBold();
                                    text.Span(Model.AgenciaDistribuidora).SemiBold().FontColor("#3b3c3c");
                                });
                            }
                            if (!string.IsNullOrEmpty(Model.Tramitante.Telefono))
                            {
                                column.Item().Text(text =>
                                {
                                    ...
                                    text.Span(Model.Tramitante.Telefono).SemiBold().FontColor("#3b3c3c");
                                });
                            }
                            if (!string.IsNullOrEmpty(Model.Tramitante.Correo))
                            {
                                column.Item().Text(text =>
                                {
                                    ...
                                    text.Span(Model.Tramitante.Correo).SemiBold().FontColor("#3b3c3c");
                                });
                            }
                        });
        ...
        void RowTable(IContainer container)
        {
            container.Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    header.Cell().Element(CellStyle).Text("Fabricante / Acondicionador");
                    ...
                    {
                        return container.DefaultTextStyle(x => x.FontSize(10).SemiBold()).PaddingVertical(10).BorderBottom(1).BorderColor(Colors.Grey.Lighten2);
                    }
                });
                ...
                foreach (var item in Model.Medicamentos)
                {
                    ...
                    table.Cell().BorderBottom(1).BorderColor(Colors.Grey.Lighten2).Element(hdl =>
                    {
                    ...
                    table.Cell().BorderBottom(1).BorderColor(Colors.Grey.Lighten2).Element(hdl =>
                    {
                        hdl.ShowEntire().Column(column =>
                        {
                            ...
                            column.Item().BorderBottom(1).BorderColor(Colors.Grey.Lighten2).PaddingBottom(5).Text(text =>
                            {

...
namespace AuditoriaApp.Components.Inspections._4_RutinaVigilanciaAgencia
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaProductosRetiradosMercado == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_AreaProductosRetiradosMercado();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaProductosRetiradosMercado.PendingUpdate = true;

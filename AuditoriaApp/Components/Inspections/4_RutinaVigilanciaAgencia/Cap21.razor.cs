    ...
    public partial class Cap21
    {
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.DatosRepresentLegal.PendingUpdate = true;
                Inspeccion.Inspeccion.InspRutinaVigAgencia.DatosRegente.PendingUpdate = true;

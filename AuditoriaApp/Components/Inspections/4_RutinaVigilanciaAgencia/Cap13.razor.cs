...
namespace AuditoriaApp.Components.Inspections._4_RutinaVigilanciaAgencia
{
    public partial class Cap13
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaAlmacenMateriaPrima == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_AreaAlmacenMateriaPrima();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaAlmacenMateriaPrima.PendingUpdate = true;

    ...
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaAlmacenProdVolatiles == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAlmacenProdVolatiles();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaAlmacenProdVolatiles.PendingUpdate = true;

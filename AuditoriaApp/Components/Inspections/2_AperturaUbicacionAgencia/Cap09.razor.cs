    ...
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaDespachoProductos == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_AreaDespachoProductos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaDespachoProductos.PendingUpdate = true;

    ...
    public partial class Cap17
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.Productos == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_Productos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.Productos.PendingUpdate = true;

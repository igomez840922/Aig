    ...
    public partial class Cap16
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.Actividades == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_Actividades();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.Actividades.PendingUpdate = true;

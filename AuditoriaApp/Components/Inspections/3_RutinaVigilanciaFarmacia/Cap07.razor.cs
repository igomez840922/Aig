...
namespace AuditoriaApp.Components.Inspections._3_RutinaVigilanciaFarmacia
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.AreaFisicaFarmacia == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_AreaFisicaFarmacia();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.AreaFisicaFarmacia.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._16_AperturaFabCosmeticoArtesanal
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Locales == null)
                {
                    Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Inicializa_Locales();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Locales.PendingUpdate = true;

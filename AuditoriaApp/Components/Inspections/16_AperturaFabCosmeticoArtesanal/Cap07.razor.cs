    ...
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal = Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal : new DatosPersona();
                //Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRegente = Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRegente != null ? Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRegente : new DatosPersona();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal.PendingUpdate = true;
                //Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.DatosRegente.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._16_AperturaFabCosmeticoArtesanal
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.AreaAlmacenamiento == null)
                {
                    Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Inicializa_AreaAlmacenamiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.AreaAlmacenamiento.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._16_AperturaFabCosmeticoArtesanal
{
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Documentacion == null)
                {
                    Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Inicializa_Documentacion();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperturaCosmetArtesanal.Documentacion.PendingUpdate = true;

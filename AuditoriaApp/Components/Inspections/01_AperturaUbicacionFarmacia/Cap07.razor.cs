...
namespace AuditoriaApp.Components.Inspections._01_AperturaUbicacionFarmacia
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosPreguntasGenericas == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicFarm.Inicializa_DatosPreguntasGenericas();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosPreguntasGenericas.PendingUpdate = true;

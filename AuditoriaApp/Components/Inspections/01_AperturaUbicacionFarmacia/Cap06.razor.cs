...
namespace AuditoriaApp.Components.Inspections._01_AperturaUbicacionFarmacia
{
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosAreaFisica == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicFarm.Inicializa_DatosAreaFisica();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosAreaFisica.PendingUpdate = true;

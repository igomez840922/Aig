...
namespace AuditoriaApp.Components.Inspections._01_AperturaUbicacionFarmacia
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {               
                if (Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosAreaAlmacenamientoAlcohol == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicFarm.Inicializa_DatosAreaAlmacenamientoAlcohol();
                }
                await LoadData();
            }
            catch { }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosAreaAlmacenamientoAlcohol.PendingUpdate = true;

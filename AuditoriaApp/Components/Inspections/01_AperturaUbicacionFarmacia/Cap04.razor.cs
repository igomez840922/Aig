...
namespace AuditoriaApp.Components.Inspections._01_AperturaUbicacionFarmacia
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosEstructuraOrganizacional == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicFarm.Inicializa_DatosEstructuraOrganizacional();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosEstructuraOrganizacional.PendingUpdate = true;

    ...
    public partial class Cap27
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRepresentLegal = Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRepresentLegal : new DatosPersona();
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRegente = Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRegente != null ? Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRegente : new DatosPersona();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRepresentLegal.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.DatosRegente.PendingUpdate = true;

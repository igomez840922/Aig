...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap23
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A2 == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_FabProdFarmEsteril_A2();
                }
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A3 == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_FabProdFarmEsteril_A3();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A2.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A3.PendingUpdate = true;

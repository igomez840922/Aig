...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap19
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ValGenerales == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ValGenerales();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ValGenerales.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Almacenes == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_Almacenes();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Almacenes.PendingUpdate = true;

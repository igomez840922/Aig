...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap25
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ProdCitostatico == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ProdCitostatico();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ProdCitostatico.PendingUpdate = true;

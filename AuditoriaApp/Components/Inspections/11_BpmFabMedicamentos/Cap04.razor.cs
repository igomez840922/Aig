...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.OtrosFuncionarios = Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.OtrosFuncionarios != null ? Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.OtrosFuncionarios : new AUD_OtrosFuncionarios();
                await LoadData();
            }
            catch { }
            finally
        ...
        private async Task RemoveParticipant(DatosPersona data)
        {
            ...
            Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.OtrosFuncionarios.LPersona.Remove(data);
            await this.InvokeAsync(StateHasChanged);
        }

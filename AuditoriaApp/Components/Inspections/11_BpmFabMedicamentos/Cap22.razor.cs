...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap22
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_FabProdFarmEsteril_A();
                }
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_Gen == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_FabProdFarmEsteril_Gen();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_Gen.PendingUpdate = true;

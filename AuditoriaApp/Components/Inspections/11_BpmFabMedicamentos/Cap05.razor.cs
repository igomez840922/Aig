...
namespace AuditoriaApp.Components.Inspections._11_BpmFabMedicamentos
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.RequisitosLegales == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_RequisitosLegales();
                }
                if(Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ClasifActComerciales == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ClasifActComerciales();
                }
                if (Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ClasifEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ClasifEstablecimiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.RequisitosLegales.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ClasifActComerciales.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiaBPMFabricanteMed.ClasifEstablecimiento.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class Cap32
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.AreaEtiquetadoEmpaque == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaEtiquetadoEmpaque();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.AreaEtiquetadoEmpaque.PendingUpdate = true;

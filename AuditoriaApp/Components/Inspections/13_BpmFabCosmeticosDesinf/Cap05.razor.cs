...
namespace AuditoriaApp.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.RequisitosLegales == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_RequisitosLegales();
                }
                if(Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.ClasifActComerciales == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_ClasifActComerciales();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.ClasifEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_ClasifEstablecimiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.RequisitosLegales.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.ClasifActComerciales.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.ClasifEstablecimiento.PendingUpdate = true;

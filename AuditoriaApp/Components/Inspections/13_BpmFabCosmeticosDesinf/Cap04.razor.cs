...
namespace AuditoriaApp.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios = Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios != null ? Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios : new AUD_OtrosFuncionarios();
                await LoadData();
            }
            catch { }
            finally
        ...
        private async Task EditParticipant(DatosPersona data = null)
        {
            ...
            if (!result.Cancelled)
            {
                if (result.Data != null)
                {
                    ...
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios.LPersona = Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios.LPersona?.Count > 0 ? Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios.LPersona : new List<DatosPersona>();
                    if (!Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios.LPersona.Contains(actividad))
                        Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios.LPersona.Add(actividad);
                    await this.InvokeAsync(StateHasChanged);
                }
            }
        ...
        private async Task RemoveParticipant(DatosPersona data)
        {
            ...
            Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios.LPersona.Remove(data);
            await this.InvokeAsync(StateHasChanged);
        }

...
namespace AuditoriaApp.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.AlmacenMateriaPrima == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AlmacenMateriaPrima();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.AlmacenMateriaPrima.PendingUpdate = true;

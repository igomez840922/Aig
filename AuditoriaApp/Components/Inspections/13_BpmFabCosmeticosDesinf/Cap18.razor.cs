...
namespace AuditoriaApp.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class Cap18
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.SistemaInstAgua == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_SistemaInstAgua();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.SistemaInstAgua.PendingUpdate = true;

    ...
    public partial class Cap23
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_MantAreaEquipos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.MantAreaEquipos.PendingUpdate = true;

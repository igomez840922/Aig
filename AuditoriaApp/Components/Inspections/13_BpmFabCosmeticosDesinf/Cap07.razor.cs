...
namespace AuditoriaApp.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.CondExtAlmacenas == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_CondExtAlmacenas();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.CondExtAlmacenas.PendingUpdate = true;

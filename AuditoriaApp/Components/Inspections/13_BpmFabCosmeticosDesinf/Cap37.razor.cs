    ...
    public partial class Cap37
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal = Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal : new DatosPersona();
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente = Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente != null ? Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente : new DatosPersona();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._1_AperturaUbicacionFarmacia
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosAreaProductosControlados == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicFarm.Inicializa_DatosAreaProductosControlados();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicFarm.DatosAreaProductosControlados.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._12_BpmAcondMedicamentos
{
    public partial class Cap18
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.QuejasReclamos == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_QuejasReclamos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.QuejasReclamos.PendingUpdate = true;

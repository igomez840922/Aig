...
namespace AuditoriaApp.Components.Inspections._12_BpmAcondMedicamentos
{
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.AreaAcondicionamiento == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_AreaAcondicionamiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.AreaAcondicionamiento.PendingUpdate = true;

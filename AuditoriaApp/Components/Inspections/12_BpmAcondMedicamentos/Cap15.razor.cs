...
namespace AuditoriaApp.Components.Inspections._12_BpmAcondMedicamentos
{
    public partial class Cap15
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.ControlCalidad == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_ControlCalidad();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.ControlCalidad.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._12_BpmAcondMedicamentos
{
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Documentacion == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_Documentacion();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Documentacion.PendingUpdate = true;

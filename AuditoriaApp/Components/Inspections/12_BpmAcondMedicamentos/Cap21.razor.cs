    ...
    public partial class Cap21
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRepresentLegal = Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRepresentLegal : new DatosPersona();
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente = Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente != null ? Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente : new DatosPersona();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRepresentLegal.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente.PendingUpdate = true;

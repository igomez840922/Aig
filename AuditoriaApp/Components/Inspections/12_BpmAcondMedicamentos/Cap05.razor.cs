...
namespace AuditoriaApp.Components.Inspections._12_BpmAcondMedicamentos
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.RequisitosLegales == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_RequisitosLegales();
                }
                if(Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.ClasifActComerciales == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_ClasifActComerciales();
                }
                if (Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.ClasifEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_ClasifEstablecimiento();
                }

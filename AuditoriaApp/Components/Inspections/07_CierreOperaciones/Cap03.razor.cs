...
namespace AuditoriaApp.Components.Inspections._07_CierreOperaciones
{
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                Inspeccion.Inspeccion.InspCierreOperacion.DatosInspeccion = Inspeccion.Inspeccion.InspCierreOperacion.DatosInspeccion != null ? Inspeccion.Inspeccion.InspCierreOperacion.DatosInspeccion : new AUD_DatosInspeccion();
                await LoadData();
            }
            catch { }
            finally
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspCierreOperacion.DatosInspeccion.PendingUpdate = true;

        ...
        protected async Task FetchData()
        {
            try
            {
                MenuOptions = MenuOptions?.Count > 0? MenuOptions: new List<MenuOptionModel>()
                {
                  ...
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap03,  Name="Información de Persona por la que Fuimos Atendidos"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap04,  Name="Productos Retirados"},

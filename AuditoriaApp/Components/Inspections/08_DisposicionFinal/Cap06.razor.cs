    ...
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspDisposicionFinal.DatosAtendidosPor = Inspeccion.Inspeccion.InspDisposicionFinal.DatosAtendidosPor != null ? Inspeccion.Inspeccion.InspDisposicionFinal.DatosAtendidosPor : new AUD_DatosAtendidosPor();

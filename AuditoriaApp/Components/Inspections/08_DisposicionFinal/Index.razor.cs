        ...
        protected async Task FetchData()
        {
            try
            {
                MenuOptions = MenuOptions?.Count > 0? MenuOptions: new List<MenuOptionModel>()
                {
                  ...
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap02,  Name="Información de Persona por la que Fuimos Atendidos"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap03,  Name="Datos de la Inspección"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap04,  Name="Inventario de Productos"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap05,  Name="Conclusiones"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap06,  Name="Firmas"},
                };

...
namespace AuditoriaApp.Components.Inspections._14_BpmFabNaturalesMed
{
    public partial class Cap16
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades15 == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades15();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Contratante == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Contratante();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Contratista == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Contratista();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades15.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Contratante.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Contratista.PendingUpdate = true;

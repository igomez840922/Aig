    ...
    public partial class Cap19
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal = Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal : new DatosPersona();
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente = Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente != null ? Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente : new DatosPersona();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._14_BpmFabNaturalesMed
{
    public partial class Cap13
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades12 == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades12();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.GarantiaCalidad == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_GarantiaCalidad();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades12.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.GarantiaCalidad.PendingUpdate = true;

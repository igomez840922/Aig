...
namespace AuditoriaApp.Components.Inspections._14_BpmFabNaturalesMed
{
    public partial class Cap14
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades13 == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades13();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Muestreo == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Muestreo();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.MetodologiaAnalitica == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_MetodologiaAnalitica();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.MaterialesReferencia == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_MaterialesReferencia();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Estabilidad == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Estabilidad();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades13.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Muestreo.PendingUpdate = true;

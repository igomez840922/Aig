...
namespace AuditoriaApp.Components.Inspections._14_BpmFabNaturalesMed
{
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades8 == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades8();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Calibracion == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Calibracion();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.SistemaAgua == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_SistemaAgua();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.SistemaAire == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_SistemaAire();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades8.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Calibracion.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.SistemaAgua.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.SistemaAire.PendingUpdate = true;

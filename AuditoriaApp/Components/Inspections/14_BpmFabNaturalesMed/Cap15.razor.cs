...
namespace AuditoriaApp.Components.Inspections._14_BpmFabNaturalesMed
{
    public partial class Cap15
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades14 == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades14();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Retiros == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Retiros();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades14.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Retiros.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._14_BpmFabNaturalesMed
{
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades10 == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades10();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DocumentosExigido == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_DocumentosExigido();
                }
                if (Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.ProcedimientoReg == null)
                {
                    Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_ProcedimientoReg();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.Generalidades10.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.DocumentosExigido.PendingUpdate = true;
                Inspeccion.Inspeccion.InspGuiBPMFabNatMedicina.ProcedimientoReg.PendingUpdate = true;

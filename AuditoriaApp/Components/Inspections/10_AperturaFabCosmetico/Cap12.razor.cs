...
namespace AuditoriaApp.Components.Inspections._10_AperturaFabCosmetico
{
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.ControlCalidad == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Inicializa_ControlCalidad();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.ControlCalidad.PendingUpdate = true;

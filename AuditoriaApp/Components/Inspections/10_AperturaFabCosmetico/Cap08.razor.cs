...
namespace AuditoriaApp.Components.Inspections._10_AperturaFabCosmetico
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.AreasAuxiliares == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Inicializa_AreasAuxiliares();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.AreasAuxiliares.PendingUpdate = true;

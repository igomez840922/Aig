...
namespace AuditoriaApp.Components.Inspections._10_AperturaFabCosmetico
{
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.SistemaCriticoApoyo == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Inicializa_SistemaCriticoApoyo();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.SistemaCriticoApoyo.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._10_AperturaFabCosmetico
{
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Acondicionamiento == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Inicializa_Acondicionamiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Acondicionamiento.PendingUpdate = true;

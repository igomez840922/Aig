    ...
    public partial class Cap15
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRepresentLegal = Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRepresentLegal : new AUD_DatosRepresentLegal();
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRegente = Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRegente != null ? Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRegente : new AUD_DatosRegente();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRepresentLegal.PendingUpdate = true;
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.DatosRegente.PendingUpdate = true;

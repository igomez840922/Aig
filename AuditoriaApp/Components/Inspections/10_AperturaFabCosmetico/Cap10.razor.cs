...
namespace AuditoriaApp.Components.Inspections._10_AperturaFabCosmetico
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.AreaProduccion == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.Inicializa_AreaProduccion();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricanteCosmetMed.AreaProduccion.PendingUpdate = true;

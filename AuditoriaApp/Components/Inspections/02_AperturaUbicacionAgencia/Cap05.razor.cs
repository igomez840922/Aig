    ...
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaRecepcionProducto == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_AreaRecepcionProducto();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaRecepcionProducto.PendingUpdate = true;

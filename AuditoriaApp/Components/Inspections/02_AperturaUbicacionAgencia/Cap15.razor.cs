    ...
    public partial class Cap15
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.Requisitos == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_Requisitos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.Requisitos.PendingUpdate = true;

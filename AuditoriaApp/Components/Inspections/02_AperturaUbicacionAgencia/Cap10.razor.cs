    ...
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaAlmacenProdReqCadenaFrio == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAlmacenProdReqCadenaFrio();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaAlmacenProdReqCadenaFrio.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._02_AperturaUbicacionAgencia
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.CondCaractEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_CondCaractEstablecimiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.CondCaractEstablecimiento.PendingUpdate = true;

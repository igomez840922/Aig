    ...
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaProductosDevueltosVencidos == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicAgen.Inicializa_AreaProductosDevueltosVencidos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicAgen.AreaProductosDevueltosVencidos.PendingUpdate = true;

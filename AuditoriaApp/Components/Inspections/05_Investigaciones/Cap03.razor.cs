...
namespace AuditoriaApp.Components.Inspections._05_Investigaciones
{
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                Inspeccion.Inspeccion.InspInvestigacion.DetallesInvestigacion = Inspeccion.Inspeccion.InspInvestigacion.DetallesInvestigacion != null ? Inspeccion.Inspeccion.InspInvestigacion.DetallesInvestigacion : new AUD_DetallesInvestigacion();
                await LoadData();
            }
            catch { }
            finally
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspInvestigacion.PendingUpdate = true;
                Inspeccion.Inspeccion.InspInvestigacion.DetallesInvestigacion.PendingUpdate = true;

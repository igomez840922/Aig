        ...
        protected async Task FetchData()
        {
            try
            {
                MenuOptions = MenuOptions?.Count > 0? MenuOptions: new List<MenuOptionModel>()
                {
                  ...
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap03,  Name="Datos de la Investigación"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap04,  Name="Conclusiones"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap05,  Name="Firmas"},
                };

...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.EstructOrganizFarmacia == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_EstructOrganizFarmacia();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.EstructOrganizFarmacia.PendingUpdate = true;

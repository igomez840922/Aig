...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.AreaAlmacenMedicamentos == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_AreaAlmacenMedicamentos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.AreaAlmacenMedicamentos.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.DatosAreaAlmacenamientoAlcohol == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_DatosAreaAlmacenamientoAlcohol();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.DatosAreaAlmacenamientoAlcohol.PendingUpdate = true;

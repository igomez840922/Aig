...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.AreaProdControlados == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_AreaProdControlados();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.AreaProdControlados.PendingUpdate = true;

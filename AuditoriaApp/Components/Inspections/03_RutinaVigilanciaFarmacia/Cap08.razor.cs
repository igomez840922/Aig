...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.RegMovimientoExistencia == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_RegMovimientoExistencia();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.RegMovimientoExistencia.PendingUpdate = true;

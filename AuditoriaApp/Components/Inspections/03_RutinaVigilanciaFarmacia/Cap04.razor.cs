...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.ExpPersonalFarmacia == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_ExpPersonalFarmacia();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.ExpPersonalFarmacia.PendingUpdate = true;

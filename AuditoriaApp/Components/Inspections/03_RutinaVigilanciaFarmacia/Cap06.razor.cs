...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.EstructFarmacia == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_EstructFarmacia();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.EstructFarmacia.PendingUpdate = true;

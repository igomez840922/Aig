...
namespace AuditoriaApp.Components.Inspections._03_RutinaVigilanciaFarmacia
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigFarmacia.RegMovimientoExistencia2 == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigFarmacia.Inicializa_RegMovimientoExistencia2();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigFarmacia.RegMovimientoExistencia2.PendingUpdate = true;

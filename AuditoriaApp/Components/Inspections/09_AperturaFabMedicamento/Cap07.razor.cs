...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.AreaAlmacenamiento == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_AreaAlmacenamiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.AreaAlmacenamiento.PendingUpdate = true;

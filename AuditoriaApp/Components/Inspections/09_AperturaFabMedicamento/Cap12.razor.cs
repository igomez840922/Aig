...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.AreaAuxiliares == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_AreaAuxiliares();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.AreaAuxiliares.PendingUpdate = true;

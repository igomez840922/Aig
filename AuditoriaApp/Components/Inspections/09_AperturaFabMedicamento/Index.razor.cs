...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
        ...
        protected async Task FetchData()
        {
            try
            {
                MenuOptions = MenuOptions?.Count > 0? MenuOptions: new List<MenuOptionModel>()
                {
                  ...
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap05,  Name="Personal"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap06,  Name="Instalaciones"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap07,  Name="Área de Almacenamiento"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap08,  Name="Área de Dispensado de Materia Prima"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap09,  Name="Área de Producción"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap10,  Name="Área de Acondicionamiento Secundario"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap11,  Name="Control de Calidad"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap12,  Name="Áreas Auxiliares"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap13,  Name="Equipos"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap14,  Name="Materiales y Productos"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap15,  Name="Conclusiones"},
                  new MenuOptionModel() { Chapter = enumSelectedChapter.Cap16,  Name="Firmas"},
                };

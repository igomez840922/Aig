...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.AreaAcondSecundario == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_AreaAcondSecundario();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.AreaAcondSecundario.PendingUpdate = true;

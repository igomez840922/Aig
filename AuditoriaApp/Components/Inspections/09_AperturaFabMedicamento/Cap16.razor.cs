    ...
    public partial class Cap16
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.DatosRepresentLegal = Inspeccion.Inspeccion.InspAperFabricante.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspAperFabricante.DatosRepresentLegal : new AUD_DatosRepresentLegal();
                Inspeccion.Inspeccion.InspAperFabricante.DatosRegente = Inspeccion.Inspeccion.InspAperFabricante.DatosRegente != null ? Inspeccion.Inspeccion.InspAperFabricante.DatosRegente : new AUD_DatosRegente();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.DatosRepresentLegal.PendingUpdate = true;
                Inspeccion.Inspeccion.InspAperFabricante.DatosRegente.PendingUpdate = true;

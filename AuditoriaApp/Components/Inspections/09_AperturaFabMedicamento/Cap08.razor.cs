...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.AreaDispMateriaPrima == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_AreaDispMateriaPrima();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.AreaDispMateriaPrima.PendingUpdate = true;

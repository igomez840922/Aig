...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.ControlCalidad == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_ControlCalidad();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.ControlCalidad.PendingUpdate = true;

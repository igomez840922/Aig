...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.AreaProduccion == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_AreaProduccion();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.AreaProduccion.PendingUpdate = true;

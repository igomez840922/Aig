...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap14
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.MaterialesProductos == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_MaterialesProductos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.MaterialesProductos.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._09_AperturaFabMedicamento
{
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspAperFabricante.Instalaciones == null)
                {
                    Inspeccion.Inspeccion.InspAperFabricante.Inicializa_Instalaciones();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperFabricante.Instalaciones.PendingUpdate = true;

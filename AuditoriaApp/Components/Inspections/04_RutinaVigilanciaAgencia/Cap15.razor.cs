...
namespace AuditoriaApp.Components.Inspections._04_RutinaVigilanciaAgencia
{
    public partial class Cap15
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.Procedimientos == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_Procedimientos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.Procedimientos.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._04_RutinaVigilanciaAgencia
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.CondCaractEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_CondCaractEstablecimiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.CondCaractEstablecimiento.PendingUpdate = true;

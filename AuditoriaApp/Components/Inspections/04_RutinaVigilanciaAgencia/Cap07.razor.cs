...
namespace AuditoriaApp.Components.Inspections._04_RutinaVigilanciaAgencia
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaProductosDevueltosVencidos == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_AreaProductosDevueltosVencidos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaProductosDevueltosVencidos.PendingUpdate = true;

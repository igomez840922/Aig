...
namespace AuditoriaApp.Components.Inspections._04_RutinaVigilanciaAgencia
{
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaAlmacenPlaguicidas == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_AreaAlmacenPlaguicidas();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaAlmacenPlaguicidas.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._04_RutinaVigilanciaAgencia
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaAlmacenProdReqCadenaFrio == null)
                {
                    Inspeccion.Inspeccion.InspRutinaVigAgencia.Inicializa_AreaAlmacenProdReqCadenaFrio();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspRutinaVigAgencia.AreaAlmacenProdReqCadenaFrio.PendingUpdate = true;

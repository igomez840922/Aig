...
namespace AuditoriaApp.Components.Inspections._17_AperturaUbicacionBotiquin
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal = Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal != null ? Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal : new AUD_DatosRepresentLegal();
                //Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRegente = Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRegente != null ? Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRegente : new DatosPersona();
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal.PendingUpdate = true;
                //Inspeccion.Inspeccion.InspAperCambUbicBotiquin.DatosRegente.PendingUpdate = true;

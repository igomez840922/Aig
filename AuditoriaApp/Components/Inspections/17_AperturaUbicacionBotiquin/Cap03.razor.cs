    ...
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion.Inspeccion.InspAperCambUbicBotiquin.CondCaractEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspAperCambUbicBotiquin.Inicializa_CondCaractEstablecimiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspAperCambUbicBotiquin.CondCaractEstablecimiento.PendingUpdate = true;

...
namespace AuditoriaApp.Components.Inspections._15_BpmBPA
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPM_Bpa.AreasEstablecimiento == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPM_Bpa.Inicializa_AreasEstablecimiento();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.AreasEstablecimiento.PendingUpdate = true;

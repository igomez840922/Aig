...
namespace AuditoriaApp.Components.Inspections._15_BpmBPA
{
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPM_Bpa.TransProdFarmaceuticos == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPM_Bpa.Inicializa_TransProdFarmaceuticos();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.TransProdFarmaceuticos.PendingUpdate = true;

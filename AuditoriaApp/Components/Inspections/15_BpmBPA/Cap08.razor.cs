...
namespace AuditoriaApp.Components.Inspections._15_BpmBPA
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPM_Bpa.Distribucion == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPM_Bpa.Inicializa_Distribucion();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.Distribucion.PendingUpdate = true;

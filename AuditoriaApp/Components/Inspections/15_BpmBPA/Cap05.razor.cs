...
namespace AuditoriaApp.Components.Inspections._15_BpmBPA
{
    public partial class Cap05
    {
        ...
        IEnumerable<PropositoInspeccion> LPropositosSelected { get; set; } = new List<PropositoInspeccion>();

        PropositoInspeccion PropositoSelected { get; set; }
        /////////////////////////
        ///
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp = Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp != null ? Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp : new AUD_PropositosInspeccion();
                if (Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp.LPropositos?.Count > 0)
                {
                    LPropositosSelected = new List<PropositoInspeccion>(Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp.LPropositos);
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp.LPropositos = new List<PropositoInspeccion>(LPropositosSelected);
                ...
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.PropositoInsp.PendingUpdate = true;

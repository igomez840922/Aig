...
namespace AuditoriaApp.Components.Inspections._15_BpmBPA
{
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                if (Inspeccion.Inspeccion.InspGuiaBPM_Bpa.AutoInspec == null)
                {
                    Inspeccion.Inspeccion.InspGuiaBPM_Bpa.Inicializa_AutoInspec();
                }
        ...
        protected async Task<bool> Save()
        {
            try
            {
                ...
                Inspeccion.Inspeccion.InspGuiaBPM_Bpa.AutoInspec.PendingUpdate = true;

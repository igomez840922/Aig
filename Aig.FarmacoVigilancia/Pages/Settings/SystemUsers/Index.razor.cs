...
namespace Aig.FarmacoVigilancia.Pages.Settings.SystemUsers
{    
    public partial class Index
    {
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            bus.Subscribe<Aig.FarmacoVigilancia.Events.SystemUsers.RegisterEvent>(RegisterEventHandler);
            bus.Subscribe<Aig.FarmacoVigilancia.Events.SystemUsers.EditEvent>(EditEventHandler);
            bus.Subscribe<Aig.FarmacoVigilancia.Events.SystemUsers.ChangePswEvent>(ChangePswEventHandler);
        ...
        public void Dispose()
        {
            ...
            bus.UnSubscribe<Aig.FarmacoVigilancia.Events.SystemUsers.RegisterEvent>(RegisterEventHandler);
            bus.UnSubscribe<Aig.FarmacoVigilancia.Events.SystemUsers.EditEvent>(EditEventHandler);
            bus.UnSubscribe<DeleteConfirmationCloseEvent>(DeleteConfirmationCloseEventHandler);

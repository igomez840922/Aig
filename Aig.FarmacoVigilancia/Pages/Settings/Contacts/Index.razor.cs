...
namespace Aig.FarmacoVigilancia.Pages.Settings.Contacts
{
    public partial class Index
    {
        ...
        private async Task OnEdit(long id)
        {
            ...
            if (result == null)
            {
                result = new FMV_ContactosTB();
            }
            dataModel.Data = result;
            //Aig.FarmacoVigilancia.Events.Ram.AddEdit_CloseEvent
            bus.Subscribe<Aig.FarmacoVigilancia.Events.Contacts.ContactsEvent>(AddEdit_CloseHandler);

            await this.InvokeAsync(StateHasChanged);
        }
        private void AddEdit_CloseHandler(MessageArgs args)
        {
            bus.UnSubscribe<Aig.FarmacoVigilancia.Events.Contacts.ContactsEvent>(AddEdit_CloseHandler);
        ...
        private async Task OnDelete(FMV_ContactosTB data)
        {

...
namespace Aig.FarmacoVigilancia.Pages.Settings.Provinces
{    
    public partial class Provinces
    {
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            bus.Subscribe<Aig.FarmacoVigilancia.Events.Province.ProvinceAddEdit_CloseEvent>(ProvinceAddEdit_CloseEvent);
        ...
        private async Task OnEdit(long id)
        {
            ...
            await bus.Publish(new Aig.FarmacoVigilancia.Events.Province.ProvinceAddEdit_OpenEvent { Data = result });
            await this.InvokeAsync(StateHasChanged);
        }
        private void ProvinceAddEdit_CloseEvent(MessageArgs args)
        {
            var message = args.GetMessage<Aig.FarmacoVigilancia.Events.Province.ProvinceAddEdit_CloseEvent>();
            FetchData();
        }

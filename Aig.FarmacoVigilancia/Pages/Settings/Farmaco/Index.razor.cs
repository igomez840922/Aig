...
namespace Aig.FarmacoVigilancia.Pages.Settings.Farmaco
{
    public partial class Index
    {
        ...
        GenericModel<FarmacoTB> dataModel { get; set; } = new GenericModel<FarmacoTB>()
        { Data = new FarmacoTB() };
        ...
        private async Task OnEdit(long id)
        {
            ...
            if (result == null)
            {
                result = new FarmacoTB();
            }
            dataModel.Data = result;
            //Aig.FarmacoVigilancia.Events.Ram.AddEdit_CloseEvent
            bus.Subscribe<Aig.FarmacoVigilancia.Events.Farmaco.AddEditEvent>(AddEdit_CloseHandler);

            await this.InvokeAsync(StateHasChanged);
        }
        private void AddEdit_CloseHandler(MessageArgs args)
        {
            bus.UnSubscribe<Aig.FarmacoVigilancia.Events.Farmaco.AddEditEvent>(AddEdit_CloseHandler);
        ...
        private async Task OnDelete(FarmacoTB data)
        {

...
{    
    public class ESAVI2Service : IESAVI2Service
    {
        ...
        public ESAVI2Service(IDalService dalService, IEmailService emailService)
        {
        ...
        public async Task SendEmailEvaluator(long Id)
        {
            try
            {
                ...
                {
                    var subject = "Asignación a trámite de ESAVI en Sistema de Farmacovigilancia";
                    ...
                    builder.TextBody = string.Format("Por este medio se le notifica que usted ha sido asignado a un trámite de ESAVI en el Sistema de Farmacovigilancia\r\n\r\n" +
                        ...
                        data.CodCNFV, data.CodigoNotiFacedra);

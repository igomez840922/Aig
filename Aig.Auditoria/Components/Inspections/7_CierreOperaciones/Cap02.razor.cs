    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspCierreOperacion.DatosRepresentLegal = Inspeccion.InspCierreOperacion.DatosRepresentLegal != null ? Inspeccion.InspCierreOperacion.DatosRepresentLegal : new AUD_DatosRepresentLegal();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_CierreOperacion_Cap2(Inspeccion);
                if (result != null)
                {

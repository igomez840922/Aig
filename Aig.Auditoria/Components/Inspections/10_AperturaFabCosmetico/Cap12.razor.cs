    ...
    public partial class Cap12
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricanteCosmetMed.ControlCalidad == null)
                {
                    Inspeccion.InspAperFabricanteCosmetMed.Inicializa_ControlCalidad();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteCosmeticosDesin_Cap12(Inspeccion);
                if (result != null)
                {

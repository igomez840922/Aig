...
namespace Aig.Auditoria.Components.Inspections._10_AperturaFabCosmetico
{
    public partial class Cap13
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricanteCosmetMed.InspeccionAuditoria == null)
                {
                    Inspeccion.InspAperFabricanteCosmetMed.Inicializa_InspeccionAuditoria();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteCosmeticosDesin_Cap13(Inspeccion);
                if (result != null)
                {

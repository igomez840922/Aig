    ...
    public partial class Cap10
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricanteCosmetMed.AreaProduccion == null)
                {
                    Inspeccion.InspAperFabricanteCosmetMed.Inicializa_AreaProduccion();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteCosmeticosDesin_Cap10(Inspeccion);
                if (result != null)
                {

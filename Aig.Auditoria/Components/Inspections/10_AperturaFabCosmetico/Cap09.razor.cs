    ...
    public partial class Cap09
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricanteCosmetMed.SistemaCriticoApoyo == null)
                {
                    Inspeccion.InspAperFabricanteCosmetMed.Inicializa_SistemaCriticoApoyo();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteCosmeticosDesin_Cap9(Inspeccion);
                if (result != null)
                {

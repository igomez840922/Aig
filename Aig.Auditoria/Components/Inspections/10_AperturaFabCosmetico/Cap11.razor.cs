    ...
    public partial class Cap11
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricanteCosmetMed.Acondicionamiento == null)
                {
                    Inspeccion.InspAperFabricanteCosmetMed.Inicializa_Acondicionamiento();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteCosmeticosDesin_Cap11(Inspeccion);
                if (result != null)
                {

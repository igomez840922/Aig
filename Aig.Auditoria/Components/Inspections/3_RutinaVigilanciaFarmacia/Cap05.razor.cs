...
namespace Aig.Auditoria.Components.Inspections._3_RutinaVigilanciaFarmacia
{
    public partial class Cap05
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion != null)
                {
                    ...
                    if (Inspeccion.InspRutinaVigFarmacia.EstructOrganizFarmacia == null)
                    {
                        Inspeccion.InspRutinaVigFarmacia.Inicializa_EstructOrganizFarmacia();
                    }
                }
                else { Cancel(); }
            }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap5(Inspeccion);
                if (result != null)
                {

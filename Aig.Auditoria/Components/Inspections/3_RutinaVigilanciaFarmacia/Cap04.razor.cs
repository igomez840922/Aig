...
namespace Aig.Auditoria.Components.Inspections._3_RutinaVigilanciaFarmacia
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                switch (Inspeccion.StatusInspecciones)
                {
                    ...
                    if (Inspeccion.InspRutinaVigFarmacia.ExpPersonalFarmacia == null)
                    {
                        Inspeccion.InspRutinaVigFarmacia.Inicializa_ExpPersonalFarmacia();
                    }
                }
                else { Cancel(); }
            }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap4(Inspeccion);
                if (result != null)
                {

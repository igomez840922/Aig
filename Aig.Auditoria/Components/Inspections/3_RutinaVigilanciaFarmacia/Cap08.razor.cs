...
namespace Aig.Auditoria.Components.Inspections._3_RutinaVigilanciaFarmacia
{
    public partial class Cap08
    {
        ...
        protected async Task FetchData()
        {
            try
            {
                ...
                if (Inspeccion != null)
                {
                    ...
                    if (Inspeccion.InspRutinaVigFarmacia.AreaProdControlados == null)
                    {
                        Inspeccion.InspRutinaVigFarmacia.Inicializa_AreaProdControlados();
                    }
                }
                else { Cancel(); }
            }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap8(Inspeccion);
                if (result != null)
                {

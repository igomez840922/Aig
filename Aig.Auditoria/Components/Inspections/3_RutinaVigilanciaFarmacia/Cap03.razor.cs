    ...
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspRutinaVigFarmacia.DatosRegente = Inspeccion.InspRutinaVigFarmacia.DatosRegente != null ? Inspeccion.InspRutinaVigFarmacia.DatosRegente : new AUD_DatosRegente();
                Inspeccion.InspRutinaVigFarmacia.DatosFarmaceutico = Inspeccion.InspRutinaVigFarmacia.DatosFarmaceutico != null ? Inspeccion.InspRutinaVigFarmacia.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap3(Inspeccion);
                if (result != null)
                {

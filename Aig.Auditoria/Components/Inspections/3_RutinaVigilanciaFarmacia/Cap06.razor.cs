...
namespace Aig.Auditoria.Components.Inspections._3_RutinaVigilanciaFarmacia
{
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                switch (Inspeccion.StatusInspecciones)
                {
                    ...
                    if (Inspeccion.InspRutinaVigFarmacia.EstructFarmacia == null)
                    {
                        Inspeccion.InspRutinaVigFarmacia.Inicializa_EstructFarmacia();
                    }
                }
                else { Cancel(); }
            }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap6(Inspeccion);
                if (result != null)
                {

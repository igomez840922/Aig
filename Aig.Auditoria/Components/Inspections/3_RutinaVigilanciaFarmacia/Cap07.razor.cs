...
namespace Aig.Auditoria.Components.Inspections._3_RutinaVigilanciaFarmacia
{
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                switch (Inspeccion.StatusInspecciones)
                {
                    ...
                    if (Inspeccion.InspRutinaVigFarmacia.AreaFisicaFarmacia == null)
                    {
                        Inspeccion.InspRutinaVigFarmacia.Inicializa_AreaFisicaFarmacia();
                    }
                }
                else { Cancel(); }
            }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap7(Inspeccion);
                if (result != null)
                {

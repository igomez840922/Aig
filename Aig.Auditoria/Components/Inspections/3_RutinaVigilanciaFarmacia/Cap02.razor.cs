    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspRutinaVigFarmacia.DatosRepresentLegal = Inspeccion.InspRutinaVigFarmacia.DatosRepresentLegal != null ? Inspeccion.InspRutinaVigFarmacia.DatosRepresentLegal : new AUD_DatosRepresentLegal();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaFarmacia_Cap2(Inspeccion);
                if (result != null)
                {

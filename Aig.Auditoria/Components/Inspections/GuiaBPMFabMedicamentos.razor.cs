...
{
    public partial class GuiaBPMFabMedicamentos
    {
        [Inject]
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (signaturePad5 != null)
                    signaturePad5.Image = Inspeccion.InspGuiaBPMFabricanteMed.RepresentLegal.Firma;
                if (signaturePad6 != null)
                    signaturePad6.Image = Inspeccion.InspGuiaBPMFabricanteMed.RegenteFarmaceutico.Firma;

                foreach (var partic in Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes)
                {
                    try
                    {
                        lSignaturePads[Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes.IndexOf(partic)].Image = partic.Firma;
                    }
                    catch (Exception ex) { }
                }
            }
        ...
        protected async Task SaveData()
        {
            try
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed?.DatosConclusiones?.LParticipantes?.Count <= 0)
                {
        ...
        //    Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Email = establecimiento?.Email ?? "";
        //    Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Telefono = establecimiento?.Telefono1 ?? "";
        //    Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Nombre = establecimiento?.Nombre ?? "";
        //    Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Direccion = establecimiento?.Ubicacion ?? "";
        //    Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Ciudad = establecimiento?.Provincia?.Nombre ?? "";
        //}


        protected async Task OnShowSignasure()
        {
            if (!showSignasure && Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes.Count > 0)
            {
        ...
        protected async Task OnSignatureChange5(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiaBPMFabricanteMed.RepresentLegal.Firma = await signaturePad5.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg5()
        {
            Inspeccion.InspGuiaBPMFabricanteMed.RepresentLegal.Firma = null;
        ...
        protected async Task OnSignatureChange6(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiaBPMFabricanteMed.RegenteFarmaceutico.Firma = await signaturePad6.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg6()
        {
            Inspeccion.InspGuiaBPMFabricanteMed.RegenteFarmaceutico.Firma = null;
        ...
        protected async Task OnSignatureChange(Participante _participante)
        {
            ...
            var _signaturePad = lSignaturePads[Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes.IndexOf(_participante)];
        ...
        protected async Task RemoveParticipant(Participante _participante)
        {
            if (_participante != null)
            {
                try
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes.Remove(_participante);
                }
                catch { }
        ...
        private void ParticipantsAddEdit_CloseEventHandler(MessageArgs args)
        {
            ...
            {
                if (!Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes.Contains(message.Data))
                    Inspeccion.InspGuiaBPMFabricanteMed.DatosConclusiones.LParticipantes.Add(message.Data);
            }
        ...
        private void Establishments_SearchEventHandler(MessageArgs args)
        {
            ...
            if (message.Data != null)
            {
                ...
                Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Email = message.Data?.Email ?? "";
                Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Telefono = message.Data?.Telefono1 ?? "";
                Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Nombre = message.Data?.Nombre ?? "";
                Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Direccion = message.Data?.Ubicacion ?? "";
                Inspeccion.InspGuiaBPMFabricanteMed.GeneralesEmpresa.Ciudad = message.Data?.Provincia?.Nombre ?? "";
            }

    ...
    public partial class Cap15
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.DistProductoTerminado == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_DistProductoTerminado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap15(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap07
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.CondExtAlmacenas == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_CondExtAlmacenas();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap7(Inspeccion);
                if (result != null)
                {

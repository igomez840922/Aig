    ...
    public partial class Cap24
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaProdCondExternas == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaProdCondExternas();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap24(Inspeccion);
                if (result != null)
                {

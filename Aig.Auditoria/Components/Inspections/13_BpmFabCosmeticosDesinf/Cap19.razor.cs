    ...
    public partial class Cap19
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.OsmosisInversa == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_OsmosisInversa();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap19(Inspeccion);
                if (result != null)
                {

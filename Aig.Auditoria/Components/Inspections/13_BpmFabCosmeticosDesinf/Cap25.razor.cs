    ...
    public partial class Cap25
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaProdCondInternas == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaProdCondInternas();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap25(Inspeccion);
                if (result != null)
                {

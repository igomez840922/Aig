    ...
    public partial class Cap04
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios = Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios != null ? Inspeccion.InspGuiBPMFabCosmeticoMed.OtrosFuncionarios : new AUD_OtrosFuncionarios();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap4(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap12
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.RecepProductoTerminado == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_RecepProductoTerminado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap12(Inspeccion);
                if (result != null)
                {

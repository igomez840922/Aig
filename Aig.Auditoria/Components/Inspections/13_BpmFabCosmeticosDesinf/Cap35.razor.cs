    ...
    public partial class Cap35
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.InspeccionAudito == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_InspeccionAudito();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap35(Inspeccion);
                if (result != null)
                {

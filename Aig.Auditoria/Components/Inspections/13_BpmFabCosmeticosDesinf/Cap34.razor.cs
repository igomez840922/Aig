    ...
    public partial class Cap34
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AnalisisContrato == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AnalisisContrato();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap34(Inspeccion);
                if (result != null)
                {

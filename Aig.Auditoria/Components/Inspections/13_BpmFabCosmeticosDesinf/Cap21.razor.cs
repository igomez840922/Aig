    ...
    public partial class Cap21
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.CalibraVerifEquipo == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_CalibraVerifEquipo();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap21(Inspeccion);
                if (result != null)
                {

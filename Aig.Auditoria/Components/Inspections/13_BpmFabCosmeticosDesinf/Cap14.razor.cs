    ...
    public partial class Cap14
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.ProductoDevueltoRechazado == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_ProductoDevueltoRechazado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap14(Inspeccion);
                if (result != null)
                {

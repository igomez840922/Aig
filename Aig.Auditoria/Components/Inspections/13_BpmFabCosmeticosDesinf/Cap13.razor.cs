    ...
    public partial class Cap13
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AlmacenProductoTerminado == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AlmacenProductoTerminado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap13(Inspeccion);
                if (result != null)
                {

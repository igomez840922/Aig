    ...
    public partial class Cap20
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.SistemaDeIonizacion == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_SistemaDeIonizacion();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap20(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap11
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AlmacenMatAcondicionamineto == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AlmacenMatAcondicionamineto();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap11(Inspeccion);
                if (result != null)
                {

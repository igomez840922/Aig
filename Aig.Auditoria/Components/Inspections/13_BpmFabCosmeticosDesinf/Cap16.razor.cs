    ...
    public partial class Cap16
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.ManejoQuejaReclamos == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_ManejoQuejaReclamos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap16(Inspeccion);
                if (result != null)
                {

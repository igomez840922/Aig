    ...
    public partial class Cap28
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.FabProdDesinfectante == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_FabProdDesinfectante();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap28(Inspeccion);
                if (result != null)
                {

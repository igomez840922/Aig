    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal = Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal != null ? Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal : new DataModel.DatosPersona();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap2(Inspeccion);
                if (result != null)
                {

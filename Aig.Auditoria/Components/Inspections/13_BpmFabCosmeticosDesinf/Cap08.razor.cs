    ...
    public partial class Cap08
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.CondIntAlmacenas == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_CondIntAlmacenas();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap8(Inspeccion);
                if (result != null)
                {

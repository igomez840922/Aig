    ...
    public partial class Cap26
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaOrganizaDocumentacion == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaOrganizaDocumentacion();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap26(Inspeccion);
                if (result != null)
                {

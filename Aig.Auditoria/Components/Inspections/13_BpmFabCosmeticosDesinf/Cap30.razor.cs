    ...
    public partial class Cap30
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.FabCosmeticos == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_FabCosmeticos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap30(Inspeccion);
                if (result != null)
                {

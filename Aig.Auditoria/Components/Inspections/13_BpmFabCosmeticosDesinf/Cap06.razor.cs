    ...
    public partial class Cap06
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AdminInfoGeneral == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AdminInfoGeneral();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap6(Inspeccion);
                if (result != null)
                {

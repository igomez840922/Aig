    ...
    public partial class Cap27
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaDispensionOrdFab == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaDispensionOrdFab();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap27(Inspeccion);
                if (result != null)
                {

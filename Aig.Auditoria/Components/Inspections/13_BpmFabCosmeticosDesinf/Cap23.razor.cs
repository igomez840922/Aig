    ...
    public partial class Cap23
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.MantAreaEquipos == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_MantAreaEquipos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap23(Inspeccion);
                if (result != null)
                {

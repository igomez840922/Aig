    ...
    public partial class Cap10
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AlmacenMateriaPrima == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AlmacenMateriaPrima();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap10(Inspeccion);
                if (result != null)
                {

...
namespace Aig.Auditoria.Components.Inspections._13_BpmFabCosmeticosDesinf
{
    public partial class CapFirmas
    {
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Firma(Inspeccion);
                if (result != null)
                {
        ...
        async Task DelayToShowSignasure()
        {
            ...
            if(SignaturePad5!=null)
                SignaturePad5.Image = Inspeccion.InspGuiBPMFabCosmeticoMed?.DatosRepresentLegal?.Firma??null;
            if (SignaturePad6 != null)
                SignaturePad6.Image = Inspeccion.InspGuiBPMFabCosmeticoMed?.DatosRegente?.Firma ?? null;
        ...
        protected async Task OnSignatureChange5(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal.Firma = await SignaturePad5.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg5()
        {
            Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRepresentLegal.Firma = null;
        ...
        protected async Task OnSignatureChange6(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente.Firma = await SignaturePad6.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg6()
        {
            Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente.Firma = null;

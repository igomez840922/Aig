    ...
    public partial class Cap33
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.LabControlCalidad == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_LabControlCalidad();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap33(Inspeccion);
                if (result != null)
                {

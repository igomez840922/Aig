    ...
    public partial class Cap31
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaEnvasado == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaEnvasado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap31(Inspeccion);
                if (result != null)
                {

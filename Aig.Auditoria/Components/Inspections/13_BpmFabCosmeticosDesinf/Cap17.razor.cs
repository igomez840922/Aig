    ...
    public partial class Cap17
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.RetiroProcMercado == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_RetiroProcMercado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap17(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap09
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaRecepMateriaPrima == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaRecepMateriaPrima();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap9(Inspeccion);
                if (result != null)
                {

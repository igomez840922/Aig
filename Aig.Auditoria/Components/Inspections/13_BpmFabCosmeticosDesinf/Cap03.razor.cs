    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente = Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente != null ? Inspeccion.InspGuiBPMFabCosmeticoMed.DatosRegente : new DataModel.DatosPersona(); 
                //Inspeccion.InspGuiBPMFabCosmeticoMed.DatosFarmaceutico = Inspeccion.InspGuiBPMFabCosmeticoMed.DatosFarmaceutico != null ? Inspeccion.InspGuiBPMFabCosmeticoMed.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap3(Inspeccion);
                if (result != null)
                {

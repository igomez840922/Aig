    ...
    public partial class Cap29
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.FabPlaguicida == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_FabPlaguicida();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap29(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap32
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.AreaEtiquetadoEmpaque == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_AreaEtiquetadoEmpaque();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap32(Inspeccion);
                if (result != null)
                {

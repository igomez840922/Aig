    ...
    public partial class Cap22
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabCosmeticoMed.Validaciones == null)
                {
                    Inspeccion.InspGuiBPMFabCosmeticoMed.Inicializa_Validaciones();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabCosmeticosDesinf_Cap22(Inspeccion);
                if (result != null)
                {

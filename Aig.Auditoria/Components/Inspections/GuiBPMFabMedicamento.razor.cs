...
namespace Aig.Auditoria.Components.Inspections
{
    public partial class GuiBPMFabMedicamento
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (signaturePad5 != null)
                    signaturePad5.Image = Inspeccion.InspGuiBPMFabMedicamento.DatosConclusiones.FirmaRepresentanteLegal;
                if (signaturePad6 != null)
                    signaturePad6.Image = Inspeccion.InspGuiBPMFabMedicamento.DatosConclusiones.FirmaRegente;
        ...
        protected async Task OnSignatureChange5(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiBPMFabMedicamento.DatosConclusiones.FirmaRepresentanteLegal = await signaturePad5.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg5()
        {
            Inspeccion.InspGuiBPMFabMedicamento.DatosConclusiones.FirmaRepresentanteLegal = null;
        ...
        protected async Task OnSignatureChange6(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiBPMFabMedicamento.DatosConclusiones.FirmaRegente = await signaturePad6.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg6()
        {
            Inspeccion.InspGuiBPMFabMedicamento.DatosConclusiones.FirmaRegente = null;

    ...
    public partial class Cap11
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.ControlCalidad == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_ControlCalidad();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap11(Inspeccion);
                if (result != null)
                {

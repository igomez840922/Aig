    ...
    public partial class Cap12
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.AreaAuxiliares == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_AreaAuxiliares();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap12(Inspeccion);
                if (result != null)
                {

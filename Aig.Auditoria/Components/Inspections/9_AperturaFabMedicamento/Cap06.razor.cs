    ...
    public partial class Cap06
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.Instalaciones == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_Instalaciones();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap6(Inspeccion);
                if (result != null)
                {

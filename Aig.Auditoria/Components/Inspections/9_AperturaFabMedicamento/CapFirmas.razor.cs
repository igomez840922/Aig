...
namespace Aig.Auditoria.Components.Inspections._9_AperturaFabMedicamento
{
    public partial class CapFirmas
    {
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Firma(Inspeccion);
                if (result != null)
                {
        ...
        async Task DelayToShowSignasure()
        {
            ...
            if(SignaturePad5!=null)
                SignaturePad5.Image = Inspeccion.InspAperFabricante?.DatosRepresentLegal?.Firma??null;
            if (SignaturePad6 != null)
                SignaturePad6.Image = Inspeccion.InspAperFabricante?.DatosRegente?.Firma ?? null;
        ...
        protected async Task OnSignatureChange5(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspAperFabricante.DatosRepresentLegal.Firma = await SignaturePad5.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg5()
        {
            Inspeccion.InspAperFabricante.DatosRepresentLegal.Firma = null;
        ...
        protected async Task OnSignatureChange6(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspAperFabricante.DatosRegente.Firma = await SignaturePad6.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg6()
        {
            Inspeccion.InspAperFabricante.DatosRegente.Firma = null;

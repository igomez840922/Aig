    ...
    public partial class Cap07
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.AreaAlmacenamiento == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_AreaAlmacenamiento();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap7(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap14
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.MaterialesProductos == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_MaterialesProductos();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap14(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspAperFabricante.DatosRepresentLegal = Inspeccion.InspAperFabricante.DatosRepresentLegal != null ? Inspeccion.InspAperFabricante.DatosRepresentLegal : new AUD_DatosRepresentLegal();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap2(Inspeccion);
                if (result != null)
                {

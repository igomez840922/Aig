...
namespace Aig.Auditoria.Components.Inspections._9_AperturaFabMedicamento
{
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspAperFabricante.ProdFabrican = Inspeccion.InspAperFabricante.ProdFabrican != null ? Inspeccion.InspAperFabricante.ProdFabrican : new AUD_InspAperFabricanteProdFabrican();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap4(Inspeccion);
                if (result != null)
                {
        ...
        protected async Task RemoveAttachment(AttachmentTB attachment)
        {
            if (attachment != null)
            {
                ...
                Inspeccion.InspAperFabricante.ProdFabrican.LAttachments.Remove(attachment);
        ...
        private void AttachmentsAddEdit_CloseEventHandler(MessageArgs args)
        {
            ...
            if (message.Attachment != null)
            {
                ...
                Inspeccion.InspAperFabricante.ProdFabrican.LAttachments = Inspeccion.InspAperFabricante.ProdFabrican.LAttachments != null ? Inspeccion.InspAperFabricante.ProdFabrican.LAttachments : new List<AttachmentTB>();

                Inspeccion.InspAperFabricante.ProdFabrican.LAttachments.Add(message.Attachment);
            }

    ...
    public partial class Cap09
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.AreaProduccion == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_AreaProduccion();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap9(Inspeccion);
                if (result != null)
                {

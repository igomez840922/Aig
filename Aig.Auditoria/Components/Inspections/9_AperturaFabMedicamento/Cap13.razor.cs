    ...
    public partial class Cap13
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.Equipos == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_Equipos();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap13(Inspeccion);
                if (result != null)
                {

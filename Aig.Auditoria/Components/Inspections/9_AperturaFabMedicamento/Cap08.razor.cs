    ...
    public partial class Cap08
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.AreaDispMateriaPrima == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_AreaDispMateriaPrima();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap8(Inspeccion);
                if (result != null)
                {

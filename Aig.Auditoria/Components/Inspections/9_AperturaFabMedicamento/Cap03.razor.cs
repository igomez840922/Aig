    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspAperFabricante.DatosRegente = Inspeccion.InspAperFabricante.DatosRegente != null ? Inspeccion.InspAperFabricante.DatosRegente : new AUD_DatosRegente();
                //Inspeccion.InspAperFabricante.DatosFarmaceutico = Inspeccion.InspAperFabricante.DatosFarmaceutico != null ? Inspeccion.InspAperFabricante.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap3(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap10
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperFabricante.AreaAcondSecundario == null)
                {
                    Inspeccion.InspAperFabricante.Inicializa_AreaAcondSecundario();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperFabricanteMedicamento_Cap10(Inspeccion);
                if (result != null)
                {

...
namespace Aig.Auditoria.Components.Inspections._3_RutinaVigilanciaAgencia
{
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspRutinaVigAgencia.DatosRegente = Inspeccion.InspRutinaVigAgencia.DatosRegente != null ? Inspeccion.InspRutinaVigAgencia.DatosRegente : new AUD_DatosRegente();
                //Inspeccion.InspRutinaVigAgencia.DatosFarmaceutico = Inspeccion.InspRutinaVigAgencia.DatosFarmaceutico != null ? Inspeccion.InspRutinaVigAgencia.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap3(Inspeccion);
                if (result != null)
                {

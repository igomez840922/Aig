    ...
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspRutinaVigAgencia.AreaRecepcionProducto == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_AreaRecepcionProducto();
                }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap6(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspRutinaVigAgencia.AreaAlmacenProdReqCadenaFrio == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_AreaAlmacenProdReqCadenaFrio();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap11(Inspeccion);
                if (result != null)
                {

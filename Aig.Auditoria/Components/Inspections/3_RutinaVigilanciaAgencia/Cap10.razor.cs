    ...
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspRutinaVigAgencia.AreaDespachoProductos == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_AreaDespachoProductos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap10(Inspeccion);
                if (result != null)
                {

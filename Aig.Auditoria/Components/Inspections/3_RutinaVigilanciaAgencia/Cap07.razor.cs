    ...
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspRutinaVigAgencia.AreaAlmacenamiento == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_AreaAlmacenamiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap7(Inspeccion);
                if (result != null)
                {

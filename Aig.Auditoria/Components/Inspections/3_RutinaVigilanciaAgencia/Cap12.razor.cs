    ...
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspRutinaVigAgencia.AreaAlmacenProdVolatiles == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_AreaAlmacenProdVolatiles();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap12(Inspeccion);
                if (result != null)
                {

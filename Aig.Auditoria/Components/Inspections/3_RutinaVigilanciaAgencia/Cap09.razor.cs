    ...
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspRutinaVigAgencia.AreaProductosRetiradosMercado == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_AreaProductosRetiradosMercado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap9(Inspeccion);
                if (result != null)
                {

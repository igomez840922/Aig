    ...
    public partial class Cap19
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspRutinaVigAgencia.Productos == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_Productos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap19(Inspeccion);
                if (result != null)
                {

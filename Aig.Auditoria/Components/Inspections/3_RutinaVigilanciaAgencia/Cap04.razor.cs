    ...
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspRutinaVigAgencia.CondCaractEstablecimiento == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_CondCaractEstablecimiento();
                }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap4(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspRutinaVigAgencia.DatosRepresentLegal = Inspeccion.InspRutinaVigAgencia.DatosRepresentLegal != null ? Inspeccion.InspRutinaVigAgencia.DatosRepresentLegal : new AUD_DatosRepresentLegal();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap2(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap18
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspRutinaVigAgencia.Actividades == null)
                {
                    Inspeccion.InspRutinaVigAgencia.Inicializa_Actividades();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RutinaVigilanciaAgencia_Cap18(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap19
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.Productos == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_Productos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap19(Inspeccion);
                if (result != null)
                {

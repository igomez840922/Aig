    ...
    public partial class Cap09
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.AreaProductosRetiradosMercado == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaProductosRetiradosMercado();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap9(Inspeccion);
                if (result != null)
                {

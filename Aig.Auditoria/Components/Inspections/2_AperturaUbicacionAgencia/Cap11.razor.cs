    ...
    public partial class Cap11
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.AreaAlmacenProdReqCadenaFrio == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAlmacenProdReqCadenaFrio();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap11(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap05
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperCambUbicAgen.AreaAdministrativa == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAdministrativa();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap5(Inspeccion);
                if (result != null)
                {

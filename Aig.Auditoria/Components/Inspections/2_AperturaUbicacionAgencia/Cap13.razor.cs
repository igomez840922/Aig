    ...
    public partial class Cap13
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.AreaAlmacenPlaguicidas == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAlmacenPlaguicidas();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap13(Inspeccion);
                if (result != null)
                {

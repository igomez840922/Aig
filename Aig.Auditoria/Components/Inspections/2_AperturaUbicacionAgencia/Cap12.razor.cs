    ...
    public partial class Cap12
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.AreaAlmacenProdVolatiles == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAlmacenProdVolatiles();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap12(Inspeccion);
                if (result != null)
                {

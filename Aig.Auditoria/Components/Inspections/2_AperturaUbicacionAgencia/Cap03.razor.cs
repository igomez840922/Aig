    ...
    public partial class Cap03
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspAperCambUbicAgen.DatosRegente = Inspeccion.InspAperCambUbicAgen.DatosRegente != null ? Inspeccion.InspAperCambUbicAgen.DatosRegente : new AUD_DatosRegente();
            }
            else { Cancel(); }

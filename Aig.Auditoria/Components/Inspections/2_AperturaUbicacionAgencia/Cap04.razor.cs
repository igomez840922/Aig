    ...
    public partial class Cap04
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperCambUbicAgen.CondCaractEstablecimiento == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_CondCaractEstablecimiento();
                }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap4(Inspeccion);
                if (result != null)
                {

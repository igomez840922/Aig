    ...
    public partial class Cap07
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperCambUbicAgen.AreaAlmacenamiento == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaAlmacenamiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap7(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap10
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.AreaDespachoProductos == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaDespachoProductos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap10(Inspeccion);
                if (result != null)
                {

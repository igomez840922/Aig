    ...
    public partial class Cap06
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperCambUbicAgen.AreaRecepcionProducto == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_AreaRecepcionProducto();
                }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap6(Inspeccion);
                if (result != null)
                {

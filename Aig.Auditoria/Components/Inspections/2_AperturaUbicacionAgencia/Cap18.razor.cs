    ...
    public partial class Cap18
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.Actividades == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_Actividades();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap18(Inspeccion);
                if (result != null)
                {

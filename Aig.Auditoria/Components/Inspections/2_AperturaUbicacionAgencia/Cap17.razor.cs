    ...
    public partial class Cap17
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspAperCambUbicAgen.Requisitos == null)
                {
                    Inspeccion.InspAperCambUbicAgen.Inicializa_Requisitos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicAgencia_Cap17(Inspeccion);
                if (result != null)
                {

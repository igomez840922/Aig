    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal = Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal != null ? Inspeccion.InspAperCambUbicBotiquin.DatosRepresentLegal : new AUD_DatosRepresentLegal();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperCamUbicBotiquin_Cap2(Inspeccion);
                if (result != null)
                {

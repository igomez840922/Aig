...
namespace Aig.Auditoria.Components.Inspections._6_RetencionRetiro
{
    public partial class Cap04
    {
        ...
        AUD_ProdRetiroRetencionTB product { get; set; } = null;
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_RetiroRetencion_Cap4(Inspeccion);
                if (result != null)
                {
        ...
        protected async Task OpenProduct(AUD_ProdRetiroRetencionTB product = null)
        {
            ...
            this.product = product != null ? product : new AUD_ProdRetiroRetencionTB();
            showProducts = true;

    ...
    public partial class Cap04
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperturaCosmetArtesanal.Locales == null)
                {
                    Inspeccion.InspAperturaCosmetArtesanal.Inicializa_Locales();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperturaFabCosmeticoArtesanal_Cap4(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal = Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal != null ? Inspeccion.InspAperturaCosmetArtesanal.DatosRepresentLegal : new DataModel.DatosPersona();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperturaFabCosmeticoArtesanal_Cap2(Inspeccion);
                if (result != null)
                {

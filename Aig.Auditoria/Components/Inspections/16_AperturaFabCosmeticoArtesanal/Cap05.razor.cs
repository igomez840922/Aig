    ...
    public partial class Cap05
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperturaCosmetArtesanal.AreaAlmacenamiento == null)
                {
                    Inspeccion.InspAperturaCosmetArtesanal.Inicializa_AreaAlmacenamiento();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperturaFabCosmeticoArtesanal_Cap5(Inspeccion);
                if (result != null)
                {

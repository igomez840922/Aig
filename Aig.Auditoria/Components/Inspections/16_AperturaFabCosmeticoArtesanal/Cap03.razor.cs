    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if(Inspeccion.InspAperturaCosmetArtesanal.Documentacion == null)
                {
                    Inspeccion.InspAperturaCosmetArtesanal.Inicializa_Documentacion();
                }                
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_AperturaFabCosmeticoArtesanal_Cap3(Inspeccion);
                if (result != null)
                {

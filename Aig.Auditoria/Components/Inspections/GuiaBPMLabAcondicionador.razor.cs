...
{    
    public partial class GuiaBPMLabAcondicionador
    {
        [Inject]
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (signaturePad5 != null)
                    signaturePad5.Image = Inspeccion.InspGuiaBPMLabAcondicionador.RepresentLegal.Firma;
                if (signaturePad6 != null)
                    signaturePad6.Image = Inspeccion.InspGuiaBPMLabAcondicionador.RegenteFarmaceutico.Firma;

                foreach (var partic in Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes)
                {
                    try
                    {
                        lSignaturePads[Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes.IndexOf(partic)].Image = partic.Firma;
                    }
                    catch (Exception ex) { }
                }
            }
        ...
        {
            if (Inspeccion.InspGuiaBPMLabAcondicionador?.DatosConclusiones?.LParticipantes?.Count <= 0)
            {
        ...
        //    Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Email = establecimiento?.Email ?? "";
        //    Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Telefono = establecimiento?.Telefono1 ?? "";
        //    Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Nombre = establecimiento?.Nombre ?? "";
        //    Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Direccion = establecimiento?.Ubicacion ?? "";
        //    Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Ciudad = establecimiento?.Provincia?.Nombre ?? "";
        //}


        protected async Task OnShowSignasure()
        {
            if (!showSignasure && Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes.Count > 0)
            {
        ...
        protected async Task OnSignatureChange5(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiaBPMLabAcondicionador.RepresentLegal.Firma = await signaturePad5.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg5()
        {
            Inspeccion.InspGuiaBPMLabAcondicionador.RepresentLegal.Firma = null;
        ...
        protected async Task OnSignatureChange6(ChangeEventArgs eventArgs)
        {
            ...
            Inspeccion.InspGuiaBPMLabAcondicionador.RegenteFarmaceutico.Firma = await signaturePad6.ToDataURL(signatureType);
        }
        protected async Task RemoveSignatureImg6()
        {
            Inspeccion.InspGuiaBPMLabAcondicionador.RegenteFarmaceutico.Firma = null;
        ...
        protected async Task OnSignatureChange(Participante _participante)
        {
            ...
            var _signaturePad = lSignaturePads[Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes.IndexOf(_participante)];
        ...
        protected async Task RemoveParticipant(Participante _participante)
        {
            if (_participante != null)
            {
                try
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes.Remove(_participante);
                }
                catch { }
        ...
        private void ParticipantsAddEdit_CloseEventHandler(MessageArgs args)
        {
            ...
            {
                if (!Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes.Contains(message.Data))
                    Inspeccion.InspGuiaBPMLabAcondicionador.DatosConclusiones.LParticipantes.Add(message.Data);
            }
        ...
        private void Establishments_SearchEventHandler(MessageArgs args)
        {
            ...
            if (message.Data != null)
            {
                ...
                Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Email = message.Data?.Email ?? "";
                Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Telefono = message.Data?.Telefono1 ?? "";
                Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Nombre = message.Data?.Nombre ?? "";
                Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Direccion = message.Data?.Ubicacion ?? "";
                Inspeccion.InspGuiaBPMLabAcondicionador.GeneralesEmpresa.Ciudad = message.Data?.Provincia?.Nombre ?? "";
            }

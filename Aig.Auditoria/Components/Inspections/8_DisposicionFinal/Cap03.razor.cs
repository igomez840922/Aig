    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspDisposicionFinal.DatosInspeccion = Inspeccion.InspDisposicionFinal.DatosInspeccion != null ? Inspeccion.InspDisposicionFinal.DatosInspeccion : new AUD_DatosInspeccionDisposicion();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_DisposicionFinal_Cap3(Inspeccion);
                if (result != null)
                {

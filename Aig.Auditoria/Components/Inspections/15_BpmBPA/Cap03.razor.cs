    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiaBPM_Bpa.DatosRegente = Inspeccion.InspGuiaBPM_Bpa.DatosRegente != null ? Inspeccion.InspGuiaBPM_Bpa.DatosRegente : new DataModel.DatosPersona(); 
                //Inspeccion.InspGuiaBPM_Bpa.DatosFarmaceutico = Inspeccion.InspGuiaBPM_Bpa.DatosFarmaceutico != null ? Inspeccion.InspGuiaBPM_Bpa.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmBPA_Cap3(Inspeccion);
                if (result != null)
                {

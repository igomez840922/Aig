    ...
    public partial class Cap09
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPM_Bpa.TransProdFarmaceuticos == null)
                {
                    Inspeccion.InspGuiaBPM_Bpa.Inicializa_TransProdFarmaceuticos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmBPA_Cap9(Inspeccion);
                if (result != null)
                {

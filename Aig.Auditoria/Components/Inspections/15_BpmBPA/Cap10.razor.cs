    ...
    public partial class Cap10
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPM_Bpa.AutoInspec == null)
                {
                    Inspeccion.InspGuiaBPM_Bpa.Inicializa_AutoInspec();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmBPA_Cap10(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap06
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPM_Bpa.DispGenerlestablecimiento == null)
                {
                    Inspeccion.InspGuiaBPM_Bpa.Inicializa_DispGenerlestablecimiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmBPA_Cap6(Inspeccion);
                if (result != null)
                {

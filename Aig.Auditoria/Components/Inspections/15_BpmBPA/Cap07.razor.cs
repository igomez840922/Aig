    ...
    public partial class Cap07
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPM_Bpa.AreasEstablecimiento == null)
                {
                    Inspeccion.InspGuiaBPM_Bpa.Inicializa_AreasEstablecimiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmBPA_Cap7(Inspeccion);
                if (result != null)
                {

...
{    
    public partial class AperturaFabricanteCosmetDesinf
    {
        [Inject]
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                if (signaturePad5 != null)
                    signaturePad5.Image = Inspeccion.InspAperFabricanteCosmetMed.DatosRepresentLegal.Firma;
                if (signaturePad6 != null)
                    signaturePad6.Image = Inspeccion.InspAperFabricanteCosmetMed.DatosRegente.Firma;

                foreach (var partic in Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes)
                {
                    try
                    {
                        lSignaturePads[Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes.IndexOf(partic)].Image = partic.Firma;
                    }
                    catch (Exception ex) { }
                }
            }
        ...
        {
            if (!showSignasure && Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes.Count > 0)
            {
        ...
        protected async Task OnSignatureChange(Participante _participante)
        {
            ...
            var _signaturePad = lSignaturePads[Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes.IndexOf(_participante)];
        ...
        protected async Task RemoveParticipant(Participante _participante)
        {
            if (_participante != null)
            {
                try
                {
                    Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes.Remove(_participante);
                }
                catch { }
        ...
        private void ParticipantsAddEdit_CloseEventHandler(MessageArgs args)
        {
            ...
            {
                if (!Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes.Contains(message.Data))
                    Inspeccion.InspAperFabricanteCosmetMed.DatosConclusiones.LParticipantes.Add(message.Data);
            }
        ...
        private void Establishments_SearchEventHandler(MessageArgs args)
        {
            ...
            if (message.Data != null)
            {
                ...
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Email = message.Data?.Email ?? "";
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Telefono = message.Data?.Telefono1 ?? "";
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Nombre = message.Data?.Nombre ?? "";
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Direccion = message.Data?.Ubicacion ?? "";
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Provincia = message.Data?.Provincia?.Nombre ?? "";
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Distrito = message.Data?.Distrito?.Nombre ?? "";
                Inspeccion.InspAperFabricanteCosmetMed.DatosEstablecimiento.Corregimiento = message.Data?.Corregimiento?.Nombre ?? "";
            }

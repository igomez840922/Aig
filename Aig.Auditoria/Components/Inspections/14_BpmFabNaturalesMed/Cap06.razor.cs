    ...
    public partial class Cap06
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabNatMedicina.AuthFuncionamiento == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_AuthFuncionamiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap6(Inspeccion);
                if (result != null)
                {

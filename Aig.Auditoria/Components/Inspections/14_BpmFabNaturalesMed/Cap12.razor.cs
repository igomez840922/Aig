    ...
    public partial class Cap12
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabNatMedicina.ProdControlProceso == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_ProdControlProceso();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap12(Inspeccion);
                if (result != null)
                {

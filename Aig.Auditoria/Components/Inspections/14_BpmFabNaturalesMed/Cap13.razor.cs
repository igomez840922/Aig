    ...
    public partial class Cap13
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabNatMedicina.Generalidades12 == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades12();
                }
                if (Inspeccion.InspGuiBPMFabNatMedicina.GarantiaCalidad == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_GarantiaCalidad();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap13(Inspeccion);
                if (result != null)
                {

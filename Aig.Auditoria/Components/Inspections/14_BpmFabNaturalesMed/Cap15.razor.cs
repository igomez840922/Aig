    ...
    public partial class Cap15
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabNatMedicina.Generalidades14 == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Generalidades14();
                }
                if (Inspeccion.InspGuiBPMFabNatMedicina.Retiros == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_Retiros();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap15(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente = Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente != null ? Inspeccion.InspGuiBPMFabNatMedicina.DatosRegente : new DataModel.DatosPersona(); 
                //Inspeccion.InspGuiBPMFabNatMedicina.DatosFarmaceutico = Inspeccion.InspGuiBPMFabNatMedicina.DatosFarmaceutico != null ? Inspeccion.InspGuiBPMFabNatMedicina.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap3(Inspeccion);
                if (result != null)
                {

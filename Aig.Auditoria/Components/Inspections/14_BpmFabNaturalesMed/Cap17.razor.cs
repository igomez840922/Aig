    ...
    public partial class Cap17
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabNatMedicina.AuditoriaCalidad == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_AuditoriaCalidad();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap17(Inspeccion);
                if (result != null)
                {

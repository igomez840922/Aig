    ...
    public partial class Cap05
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiBPMFabNatMedicina.InfoGeneral == null)
                {
                    Inspeccion.InspGuiBPMFabNatMedicina.Inicializa_InfoGeneral();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap5(Inspeccion);
                if (result != null)
                {

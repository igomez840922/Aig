    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal = Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal != null ? Inspeccion.InspGuiBPMFabNatMedicina.DatosRepresentLegal : new DataModel.DatosPersona();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabNaturalesMed_Cap2(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap18
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.ProdAnalisisContrato == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ProdAnalisisContrato();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap18(Inspeccion);
                if (result != null)
                {

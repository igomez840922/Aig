    ...
    public partial class Cap13
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.MatProducts == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_MatProducts();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap13(Inspeccion);
                if (result != null)
                {

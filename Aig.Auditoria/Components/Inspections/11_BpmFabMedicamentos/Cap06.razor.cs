    ...
    public partial class Cap06
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.OrganizacionPersonal == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_OrganizacionPersonal();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap6(Inspeccion);
                if (result != null)
                {

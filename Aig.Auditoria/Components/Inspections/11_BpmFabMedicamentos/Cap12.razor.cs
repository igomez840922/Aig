    ...
    public partial class Cap12
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.EquiposGeneralidades == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_EquiposGeneralidades();
                }
                if (Inspeccion.InspGuiaBPMFabricanteMed.Equipos == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_Equipos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap12(Inspeccion);
                if (result != null)
                {

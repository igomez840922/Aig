    ...
    public partial class Cap09
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.AreaDispMatPrima == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_AreaDispMatPrima();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap9(Inspeccion);
                if (result != null)
                {

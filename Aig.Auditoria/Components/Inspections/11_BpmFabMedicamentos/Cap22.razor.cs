    ...
    public partial class Cap22
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_A == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_FabProdFarmEsteril_A();
                }
                if (Inspeccion.InspGuiaBPMFabricanteMed.FabProdFarmEsteril_Gen == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_FabProdFarmEsteril_Gen();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap22(Inspeccion);
                if (result != null)
                {

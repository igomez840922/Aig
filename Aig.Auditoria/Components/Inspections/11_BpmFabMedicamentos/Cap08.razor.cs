    ...
    public partial class Cap08
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.Almacenes == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_Almacenes();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap8(Inspeccion);
                if (result != null)
                {

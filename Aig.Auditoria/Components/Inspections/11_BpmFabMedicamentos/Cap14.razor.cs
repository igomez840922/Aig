    ...
    public partial class Cap14
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.Documentacion == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_Documentacion();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap14(Inspeccion);
                if (result != null)
                {

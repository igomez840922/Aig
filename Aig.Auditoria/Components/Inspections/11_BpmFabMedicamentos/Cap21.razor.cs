    ...
    public partial class Cap21
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.AutoInspecAuditCal == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_AutoInspecAuditCal();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap21(Inspeccion);
                if (result != null)
                {

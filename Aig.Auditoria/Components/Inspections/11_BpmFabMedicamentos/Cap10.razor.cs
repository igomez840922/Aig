    ...
    public partial class Cap10
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.AreaProduccion == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_AreaProduccion();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap10(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap25
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.ProdCitostatico == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ProdCitostatico();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap25(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap07
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.EdifInstalaciones == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_EdifInstalaciones();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap7(Inspeccion);
                if (result != null)
                {

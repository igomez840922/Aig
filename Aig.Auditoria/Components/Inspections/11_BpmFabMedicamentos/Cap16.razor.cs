    ...
    public partial class Cap16
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.GarantiaCalidad == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_GarantiaCalidad();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap16(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap24
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.Lactamicos == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_Lactamicos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap24(Inspeccion);
                if (result != null)
                {

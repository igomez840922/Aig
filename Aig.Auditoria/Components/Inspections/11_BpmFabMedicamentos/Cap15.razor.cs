    ...
    public partial class Cap15
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.Produccion == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_Produccion();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap15(Inspeccion);
                if (result != null)
                {

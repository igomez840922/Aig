    ...
    public partial class Cap20
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.QuejasReclamos == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_QuejasReclamos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap20(Inspeccion);
                if (result != null)
                {

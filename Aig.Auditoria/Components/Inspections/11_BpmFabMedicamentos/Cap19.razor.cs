    ...
    public partial class Cap19
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.ValGenerales == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_ValGenerales();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap19(Inspeccion);
                if (result != null)
                {

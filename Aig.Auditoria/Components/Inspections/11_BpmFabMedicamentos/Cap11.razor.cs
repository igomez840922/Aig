    ...
    public partial class Cap11
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMFabricanteMed.AreaAcondicionamiento == null)
                {
                    Inspeccion.InspGuiaBPMFabricanteMed.Inicializa_AreaAcondicionamiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmFabMededicamentos_Cap11(Inspeccion);
                if (result != null)
                {

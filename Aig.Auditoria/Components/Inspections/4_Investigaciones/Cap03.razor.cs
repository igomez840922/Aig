    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspInvestigacion.DetallesInvestigacion = Inspeccion.InspInvestigacion.DetallesInvestigacion != null ? Inspeccion.InspInvestigacion.DetallesInvestigacion : new AUD_DetallesInvestigacion();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_Investigaciones_Cap3(Inspeccion);
                if (result != null)
                {

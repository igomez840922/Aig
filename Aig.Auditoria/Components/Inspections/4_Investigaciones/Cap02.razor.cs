    ...
    public partial class Cap02
    {
        ...
        protected async Task FetchData()
        {
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspInvestigacion.DatosAtendidosPor = Inspeccion.InspInvestigacion.DatosAtendidosPor != null ? Inspeccion.InspInvestigacion.DatosAtendidosPor : new AUD_DatosAtendidosPor();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_Investigaciones_Cap2(Inspeccion);
                if (result != null)
                {

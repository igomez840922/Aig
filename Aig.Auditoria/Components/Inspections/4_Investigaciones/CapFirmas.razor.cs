...
namespace Aig.Auditoria.Components.Inspections._4_Investigaciones
{
    public partial class CapFirmas
    {
        ...
        async Task DelayToShowSignasure()
        {
            ...
            //    signaturePad6.Image = Inspeccion.InspInvestigacion?.DatosRegente?.Firma ?? null;
        ...
        //        var signatureType = (SignaturePad.SupportedSaveAsTypes)Enum.Parse(typeof(SignaturePad.SupportedSaveAsTypes), eventArgs.Value as string);
        //    }
        //    Inspeccion.InspInvestigacion.DatosAtendidosPor.Firma = await signaturePad6.ToDataURL(signatureType);
        //}

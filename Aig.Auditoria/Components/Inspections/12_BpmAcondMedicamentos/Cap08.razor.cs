    ...
    public partial class Cap08
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.Almacenes == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_Almacenes();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap8(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap09
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.AreaAcondicionamiento == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_AreaAcondicionamiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap9(Inspeccion);
                if (result != null)
                {

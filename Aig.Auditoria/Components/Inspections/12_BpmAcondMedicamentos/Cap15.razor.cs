    ...
    public partial class Cap15
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.ControlCalidad == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_ControlCalidad();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap15(Inspeccion);
                if (result != null)
                {

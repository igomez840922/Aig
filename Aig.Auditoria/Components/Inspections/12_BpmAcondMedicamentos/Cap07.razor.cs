    ...
    public partial class Cap07
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.EdifInstalaciones == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_EdifInstalaciones();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap7(Inspeccion);
                if (result != null)
                {

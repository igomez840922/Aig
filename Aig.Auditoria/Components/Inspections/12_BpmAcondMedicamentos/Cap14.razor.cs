    ...
    public partial class Cap14
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.GarantiaCalidad == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_GarantiaCalidad();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap14(Inspeccion);
                if (result != null)
                {

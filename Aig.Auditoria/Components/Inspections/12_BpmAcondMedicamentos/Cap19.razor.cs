    ...
    public partial class Cap19
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.AutoInspecAuditCal == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_AutoInspecAuditCal();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap19(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap12
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.Documentacion == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_Documentacion();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap12(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap11
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.MatProducts == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_MatProducts();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap11(Inspeccion);
                if (result != null)
                {

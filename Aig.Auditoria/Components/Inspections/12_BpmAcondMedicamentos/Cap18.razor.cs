    ...
    public partial class Cap18
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.QuejasReclamos == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_QuejasReclamos();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap18(Inspeccion);
                if (result != null)
                {

    ...
    public partial class Cap17
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.ValGenerales == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_ValGenerales();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap17(Inspeccion);
                if (result != null)
                {

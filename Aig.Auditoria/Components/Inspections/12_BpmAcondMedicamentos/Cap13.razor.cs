    ...
    public partial class Cap13
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.Acondicionamiento == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_Acondicionamiento();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap13(Inspeccion);
                if (result != null)
                {

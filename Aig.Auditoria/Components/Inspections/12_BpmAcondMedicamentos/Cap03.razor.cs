    ...
    public partial class Cap03
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente = Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente != null ? Inspeccion.InspGuiaBPMLabAcondicionador.DatosRegente : new DataModel.DatosPersona(); 
                //Inspeccion.InspGuiaBPMLabAcondicionador.DatosFarmaceutico = Inspeccion.InspGuiaBPMLabAcondicionador.DatosFarmaceutico != null ? Inspeccion.InspGuiaBPMLabAcondicionador.DatosFarmaceutico : new AUD_DatosFarmaceutico();
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap3(Inspeccion);
                if (result != null)
                {

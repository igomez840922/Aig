    ...
    public partial class Cap16
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.ProdAnalisisContrato == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_ProdAnalisisContrato();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap16(Inspeccion);
                if (result != null)
                {

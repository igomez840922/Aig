    ...
    public partial class Cap10
    {
        ...
        {            
            ...
            if (Inspeccion != null)
            {
                ...
                if (Inspeccion.InspGuiaBPMLabAcondicionador.EquiposGeneralidades == null)
                {
                    Inspeccion.InspGuiaBPMLabAcondicionador.Inicializa_EquiposGeneralidades();
                }
            }
            else { Cancel(); }
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_BpmAcondMedicamentos_Cap10(Inspeccion);
                if (result != null)
                {

...
namespace Aig.Auditoria.Components.Inspections._5_Investigaciones
{
    public partial class CapFirmas
    {
        ...
        //Mobsites.Blazor.SignaturePad Mobsites.Blazor.SignaturePad6;
        ...
        protected async Task SaveData()
        {
            try
            {
                var result = await inspeccionService.Save_Investigaciones_Frima(Inspeccion);
                if (result != null)
                {
        ...
        async Task DelayToShowSignasure()
        {
            ...
            if(SignaturePad5!=null)
                SignaturePad5.Image = Inspeccion.InspInvestigacion?.DatosAtendidosPor?.Firma??null;
            //if (Mobsites.Blazor.SignaturePad6 != null)
            //    Mobsites.Blazor.SignaturePad6.Image = Inspeccion.InspInvestigacion?.DatosRegente?.Firma ?? null;
        ...
        //        var signatureType = (Mobsites.Blazor.SignaturePad.SupportedSaveAsTypes)Enum.Parse(typeof(Mobsites.Blazor.SignaturePad.SupportedSaveAsTypes), eventArgs.Value as string);
        //    }
        //    Inspeccion.InspInvestigacion.DatosAtendidosPor.Firma = await Mobsites.Blazor.SignaturePad6.ToDataURL(signatureType);
        //}
        //protected async Task RemoveSignatureImg6()
        //{
        //    Inspeccion.InspInvestigacion.DatosRegente.Firma = null;
        //    Mobsites.Blazor.SignaturePad6.Image = null;
        //}

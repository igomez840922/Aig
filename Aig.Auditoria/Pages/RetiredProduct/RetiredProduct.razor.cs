...
{   
    public partial class RetiredProduct
    {
        ...
        private async Task OnEdit(long id)
        {
            ...
            if (result == null)
            {
                result = new AUD_InspeccionTB() { TipoActa = DataModel.Helper.enumAUD_TipoActa.RR, DatosEstablecimiento = new AUD_DatosEstablecimientoTB(), InspRetiroRetencion = new AUD_InspRetiroRetencionTB() };
            }

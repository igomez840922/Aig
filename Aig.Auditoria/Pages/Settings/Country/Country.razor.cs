...
namespace Aig.Auditoria.Pages.Settings.Country
{   
    public partial class Country
    {
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            bus.Subscribe<Aig.Auditoria.Events.Country.CountryAddEdit_CloseEvent>(CountryAddEdit_CloseEventHandler);
            base.OnInitialized();
        }
        ...
        private async Task OnEdit(long id)
        {
            ...
            await bus.Publish(new Aig.Auditoria.Events.Country.CountryAddEdit_OpenEvent { Data = result });
            await this.InvokeAsync(StateHasChanged);
        }
        private void CountryAddEdit_CloseEventHandler(MessageArgs args)
        {
            var message = args.GetMessage<Aig.Auditoria.Events.Country.CountryAddEdit_CloseEvent>();
            FetchData();
        }
        ...
        {
            var result = await countriesService.Delete(dataModel.Data?.Id ?? 0);
            if (result != null)
            {
